...
export const answerData = {
  ...
  "can't believe": {
    ...
    text: [
      ...
      "But yeah, we are getting married on the 26th of February in a close family and friends function in RSB sabha bhavana, Manipal",
  ...
  groom: {
    ...
    text: [
      ...
      "https://www.instagram.com/skrakesh5?igsh=YzVkODRmOTdmMw==",
      "You know what i'll still take you to Rashmis profile :p",
      "This is me Rashmi",
      bride,
      ...
      "By the way, i'll show you around our place. Would you like an itinerary for around Manipal?",
    ],
